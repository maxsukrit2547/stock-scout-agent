...
# Gemini client (created lazily so missing env doesn't crash on import)
_client = None
...
def git_commit_portfolio():
    """Best-effort commit/push of portfolio.json. Silent on any failure (e.g. not in a git repo)."""
    try:
